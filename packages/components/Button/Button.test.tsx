import { describe, it, test, expect, vi } from "vitest"; // 引入Vitest测试框架的常用方法
import { mount } from "@vue/test-utils"; // 引入Vue测试工具库，用于组件挂载和测试

import Button from "./Button.vue"; // 导入待测试的Button组件
